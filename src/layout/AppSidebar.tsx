import { Aperture, Film, MapPinHouse, NotebookPen } from 'lucide-react';
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Photo Gallery",
    subItems: [
      { name: "View Photos", path: "/photos", pro: false },
      { name: "Add Photos", path: "/add-photos", pro: false },
    ],
  },
  {
    icon: <Film />,
      ...
      {items.map((nav, index) => (
        <li key={nav.name}>
          ...
          {nav.subItems && (isExpanded || isHovered || isMobileOpen) && (
            ...
            >
              <ul className="mt-4 space-y-1 ml-9">
